...
#starting summoners
hist = getHistory("ZsRTE08by5S1tlGOnXlhnIMy5Dlri35TrwbUIUnROsCvkis")
SUMMONERS = [
    {
        'id': "ZsRTE08by5S1tlGOnXlhnIMy5Dlri35TrwbUIUnROsCvkis",
        'summId': 'I2mDUyYdvphw8-4X2_xp0kZa1Dt2BoIgw7e65C5BHnwZjhc',
        'name': 'sodhi',
        'history': hist,
        'startIndex': 0,
        'endIndex': 10,
        'matchInfo': getMatch(hist, "ZsRTE08by5S1tlGOnXlhnIMy5Dlri35TrwbUIUnROsCvkis"),
        'rank': getRank('I2mDUyYdvphw8-4X2_xp0kZa1Dt2BoIgw7e65C5BHnwZjhc')
    },
]
