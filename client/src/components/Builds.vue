...
.bld-RuneHeader { grid-area: bld-RuneHeader; text-align: left; }

.bld-Runes { grid-area: bld-Runes; }

.bld-SkillHeader { grid-area: bld-SkillHeader; text-align: left; }

.bld-Skills { grid-area: bld-Skills; }

.bld-ItemHeader { grid-area: bld-ItemHeader; text-align: left; }
  ...
  <div class="parent">
    ...
    <div class="build">
      <div class="bld-grid-container">
        <div class="bld-Header"><h1>{{ selected.name }}</h1></div>
        <div class='bld-Role'>
          <b-row>
            <b-col>
              <b-row>
                ...
                <b-col style="align-self:center;">
                  <img :src='build.spells[0].imgPath' :alt='build.spells[0].name'
                  style="padding: 5%">
                  <img :src='build.spells[1].imgPath' :alt='build.spells[0].name'
                  style="padding: 5%">
                </b-col>
              </b-row>
            </b-col>
        ...
        <div class="bld-RuneHeader"><h4>Runes</h4></div>
        <div class="bld-Runes">
          <b-row>
            <b-col>
              <b-row>
        ...
        <div class="bld-SkillHeader"><h4>Skills</h4></div>
